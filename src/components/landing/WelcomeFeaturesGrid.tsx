...
export function WelcomeFeaturesGrid({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-primary/[0.04] via-transparent to-transparent" aria-hidden />
      ...
      <div className="relative mx-auto w-full max-w-7xl space-y-10 px-6 lg:px-8">
        <AnimatedContainer className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-balance text-sm tracking-wide text-muted-foreground md:text-base">
            {subtitle}
          </p>
        </AnimatedContainer>
